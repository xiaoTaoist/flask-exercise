...
from todolist.apis.v1.errors import api_abort, ValidationError
from todolist.apis.v1.auth import auth_required, generate_token
from todolist.apis.v1.schemas import item_schema, user_schema, items_schema
...
class ItemsAPI(MethodView):
    ...
    def get(self):
        ...
        return jsonify(item_schema(items, current, prev, next, pagination))
